...
public class CategoryController {
	...
	public ResponseEntity<CategoryDTO> createCategory(@Valid @RequestBody Categories category) {
	...
	public ResponseEntity<CategoryDTO> updateCategory(@RequestBody Categories category,
