...
import com.E_CommerceApplication.App.service.AddressService;
...
public class AddressController {
    ...
    public ResponseEntity<AddressDTO> createAddress(@Valid @RequestBody AddressDTO addressDTO){
        ...
        AddressDTO saveAddress = addressService.createAddress(addressDTO);
    ...
    public ResponseEntity<AddressDTO> getAddressDTO(@PathVariable Long addressId){
    ...
    public ResponseEntity<AddressDTO> updateAddress(@PathVariable Long addressId, @RequestBody Address address){
        AddressDTO addressDTO2 = addressService.updateAddress(addressId,address);
        return new ResponseEntity<AddressDTO>(addressDTO2, HttpStatus.OK);
    }
